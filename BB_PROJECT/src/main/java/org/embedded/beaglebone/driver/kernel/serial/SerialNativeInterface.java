 ...
 */
package org.embedded.beaglebone.driver.kernel.serial;
...
public class SerialNativeInterface {
    ...
    static {
        ...
        System.loadLibrary("jSSC-" + libVersion);
    ...
    public static native long[] waitForDataOnPorts(long[] handles, long timeout);
     ...
     * @return
     */
    public native byte[] readBytesWithTimeout(long handle, long timeout);
    ...
    public native boolean writeBytesWithLength(long handle, byte[] buffer, int length);
	...
	public native long open(String fileName, int flags);
	public native boolean close(long handle);
     ...
     * @return Method returns the array of read bytes
     */
    public native byte[] readReadyBytes(long handle, int byteCount);
